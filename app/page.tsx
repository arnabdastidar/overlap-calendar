    ...
    <main className="app-shell">
      ...
      <section className="workspace">
        ...
        <section className="connection-card">
          ...
          <div><strong>{uniqueMembers.find((member) => member.id === group.participantId)?.providers.length ? "Your calendar is in the overlap" : "Bring your calendar into the overlap"}</strong><p>We only read free/busy status — event titles and details stay private.</p></div>
          <button type="button" onClick={() => setModal("connect")}>Connect calendar <span>→</span></button>
        </section>
      </section>
